...
namespace WeChatManagementSample.EntityFrameworkCore
{
    ...
    public class WeChatManagementSampleDbContext :
        AbpDbContext<WeChatManagementSampleDbContext>,
        IIdentityDbContext,
        ITenantManagementDbContext
    {
        ...
        public WeChatManagementSampleDbContext(DbContextOptions<WeChatManagementSampleDbContext> options)
            : base(options)
        {
